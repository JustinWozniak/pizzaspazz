const list = [
    {
        question: "How can I get Pizza Spazz Franchise?",
        answer: "Tap FoodWorks Limited is the Master Franchisee of Pizza Spazz in India, Bangladesh, Sri Lanka and Nepal with sole and exclusive rights to own and operate Pizza Spazz restaurants in these territories. For any franchise-related queries, kindly email us directly at no-mail@email.com"
    },
    {
        question: "Can gift cards be used along with credit cards / other wallets for purchasing Pizza Spazz's products?",
    ...
    },
    {
        ...
        answer: "Yes, up to 10 Gift Cards during a transaction. To purchase larger quantities, contact Pizza Spazz corporate at no-mail@email.com"
    },
    {
    ...
    {
        question: "In what denominations is Pizza Spazz's Paper Voucher sold?",
        answer: "In 3 fixed denominations INR 100, INR 200 and INR 500."
    },
    {
        question: "How will NEW PIZZA Spazz'S PAPER VOUCHER be redeemed?",
        answer: "These are redeemed at store and online."
    },
    {
        question: "How will OLD PIZZA Spazz'S PAPER VOUCHER will be redeemed?",
        answer: "These will be redeemed in CASHLESS (As per existing process)."
    },
    {
        question: "How will OLD PIZZA Spazz'S EGV will be redeemed?",
        answer: "Existing 11-character alphanumeric Pizza Spazz?s E-GVs can be redeemed at stores and online. NO PIN will be required also these will be redeemed ONE TIME ONLY."
    },
    {
    ...
    {
        question: "How to find Pizza Spazz's Gift Card Balance through SMS?",
        answer: "SMS DOM BAL 10-digit card number to 00000."
    },
    {
        question: "Which are the different gift cards being sold by Pizza Spazz's?",
        answer: "Pizza Spazz's Gift Cards are available in various forms - Plastic card, Electronic-Gift Voucher and Mobile Gift Card."
    },
    {
        question: "What can be bought using a Pizza Spazz's gift card/voucher?",
        answer: "Pizza Spazz's Gift Card is a pre-loaded gift card, which can be used for purchasing any Pizza Spazz's product (Pizza, Sides or Beverages) in all participating restaurants or order online from desktop/laptop on www.pizza-Spazz.com to know the steps."
    },
    {
        question: "How to activate Pizza Spazz's Physical Gift Card?",
        answer: "One needs to activate a physical gift card to use it. To activate the card, SMS DOM ACT 10-digit card number 6-digit card pin to 00000 from recipient's mobile number. This would link your gift card to your mobile number. Now for all future transactions at Pizza Spazz's outlet/web, OTP will be sent to the registered mobile number to authorize redemption transactions for this card."
    },
    {
    ...
    {
        question: "How to find Pizza Spazz's Gift Card balance on Website?",
        answer: "Visit Pizza Spazz's Website Gift Card Page under Balance Enquiry enter 10-digit gift card number."
    },
    {
        question: "How is Pizza Spazz's Physical card different from Paper Gift Voucher, Electronic Gift Voucher and Mobile Gift Voucher?",
        answer: "Plastic Card is reloadable and redeemable multiple times however all other are for ONE TIME USE ONLY."
    },
    {
        question: "How will Pizza Spazz'S Paper Voucher will be redeemed?",
        answer: "These will be redeemed in store and on delivery."
    },
    {
        question: "How will Pizza Spazz'S Electronic Voucher be redeemed?",
        answer: "These are redeemed at store and online (only on web). For online logon to www.pizza-Spazz.com from your desktop/laptop. Apply it on the payment page under Gift Card / Evoucher."
    },
    {
        question: " In what denominations is Pizza Spazz's Gift Card sold?",
        answer: "Pizza Spazz's Gift Card (Physical Card) can be purchased for variable denomination ranging between minimum value of Rs. 500 and maximum Rs. 49,999."
    },
    {
        question: " In what denominations is Pizza Spazz's Electronic Voucher sold?",
        answer: "The Pizza Spazz's Electronic Gift Voucher can be purchased for variable denomination ranging between minimum value of Rs. 100 and maximum Rs. 2,000."
    },
    {
        question: "How long does it take to receive Gift Card when ordered online?",
        answer: "Pizza Spazz's Gift Card usually takes 7-9 working days to reach. E-Gift Cards are normally delivered instantly. But sometimes due to system issues, the delivery can be delayed up-to 24 hours."
    },
    {
        question: "Can I purchase more than 1 Gift Card at a time?",
        answer: "Yes, up to 10 Gift Cards during a transaction on www.pizza-Spazz.com. For bulk purchase: contact Pizza Spazzs corporate at no-mail@email.com"
    },
    {
        question: "How do I cancel my Pizza Spazz's Gift Card purchase?",
        answer: "The purchase of Pizza Spazz's Gift card cannot be cancelled after placing the order."
    },
    {
        question: "How do I cancel my Pizza Spazz's Gift Card at the store?",
        answer: "Please ensure that Pizza Spazz's Physical Card is activated before presenting it for redemption at the store. To redeem please hand over card to store staff, an OTP will be sent to registered mobile number to approve."
    },
    {
        question: "Should the entire value of the Pizza Spazz's Gift Card must be redeemed at once?",
    ...
    },
    {
        ...
        answer: "Use the reload option in the gift cards section of pizza-Spazz.com website to perform the Reload / Recharge. The reload option is applicable only for physical gift cards."
    },
    {
    ...
    },
    {
        ...
        answer: "You Can order online through www.pizza-Spazz.com"
    },
    {
        question: "How to redeem E.Gift Voucher?",
        answer: "Go to Pizza Spazz's website  www.pizza-Spazz.com, select your pizzas and without applying any offer code under redeem code page, move to 'Proceed to payment' page option, on left side you will find multiple payment options. Under that option one option will be 'E.Gift Voucher' Click on that link, enter the code and your bill value will be deducted by the voucher value."
    },
    {
        question: "Code is not redeeming",
        answer: "Do not apply any offer code. Apply code only on the payment page and Select right combination of products any order above Rs. 300 shall be eligible for delivery rest orders will be Pick up orders or else adding of one Pizza is Spazzdatory for delivery."
    },
    {
    ...
    },
    {
        ...
        answer: "You can buy gift vouchers at www.pizza-Spazz.com/gift-voucher"
    },
    {
    ...
    },
    {
        ...
        answer: "Please ensure that you are on 'www.pizza-Spazz.com/menu'"
    },
    {
    ...
    },
    {
        ...
        answer: "Please check out our Terms & Conditions at www.pizza-Spazz.com/terms-and-conditions"
    },
    {
        question: "Please specify Product description!",
        answer: "Please check out our Menu at www.pizza-Spazz.com/menu"
    },
    {
    ...
    {
        question: "What are the Delivery Times at Pizza Spazz's Pizza?",
        answer: "We at Pizza Spazz deliver from 11 AM to 11 PM"
    },
    {
        question: "What is the Operative Window for Pizza Spazz's Pizza?",
        answer: "We at Pizza Spazz operate  from 11 AM to 11 PM"
    }
]
